...
int main(void) {
  ...
  lUsuarios[0] = (struct Usuario){ADMINISTRADOR, "Mike", "admin", "1234"};
            ...
            switch (opcion) {
              ...
              case 1:
              {
                  ...
                  if (existe == 0 && contador < 10) {
                      ...
                      struct Usuario usuario_nuevo = crear_usuario(u, nombre, usuario, password);
              ...
              case 2:
                {
                  ...
                  if (indice_usuario_encontrado != -1) {
                      ...
                      usuario_p = actualizar_usuario(u, lUsuarios[indice_usuario_encontrado]);
  
                      lUsuarios[indice_usuario_encontrado] = usuario_p;
              ...
              case 3:
              {
                  ...
                  if (existe == 0 && contador <=20) {
                      ...
                      p = crear_producto(u, nombre, precio_compra, marca, codigo);
              ...
              case 4:
                {
                    ...
                    if (indice_producto_encontrado != -1) {
                        ...
                        struct Producto producto_actualizado = actualizar_producto(u, p);
              ...
              case 5:
              {
                ...
                struct Venta nuevaVenta = vender_producto(u, lProductos[opcion_producto - 1], &sucursales[opcion_sucursal - 1], precio_venta);
